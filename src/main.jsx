...
import {Home,Users,TableProperties,ClipboardList,Bot,Settings,Plus,Trash2,Save,Edit3,Printer as PrinterIcon,Sparkles,WifiOff,Wifi,ArrowUpDown,GraduationCap,FileText,Search,UserPlus,ChevronLeft,ChevronRight,BookOpen,CheckCircle2,Clock3,Layers3,Library,Upload,FolderOpen,CalendarDays} from 'lucide-react';
...
إذا كان جزء من المطلوب غير موجود أو غير واضح في الصفحات، اذكر ذلك صراحة ولا تخترع محتوى.`;
 ...
 useEffect(()=>persist('m2_grade',grade),[grade]); useEffect(()=>persist('m2_section',section),[section]); useEffect(()=>persist('m2_subject',subject),[subject]); useEffect(()=>persist('m2_library_books',libraryBooks),[libraryBooks]); useEffect(()=>persist('m2_curriculum_plans',savedPlans),[savedPlans]);
